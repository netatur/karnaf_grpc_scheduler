...
from common.config import API_HOST, API_PORT, REQUEST_QUEUE, REQUEST_RETRY_EXCHANGE, REQUEST_DELAYED_EXCHANGE, \
    REQUEST_DELAYED_ROUTING_KEY
from common.infra.queue.rabbit.rabbit_producer import RabbitMQProducer

app = FastAPI()
producer = RabbitMQProducer(REQUEST_QUEUE, REQUEST_RETRY_EXCHANGE, REQUEST_DELAYED_EXCHANGE, REQUEST_DELAYED_ROUTING_KEY)
